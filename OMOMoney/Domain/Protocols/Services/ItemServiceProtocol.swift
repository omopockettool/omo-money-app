...
protocol ItemServiceProtocol {
    ...
    /// Fetch item by ID
    /// - Returns: Core Data Item entity (NSManagedObject subclass)
    ...
    /// Delete an item
    /// - Parameter item: Core Data Item entity to delete
    func deleteItem(_ item: Item) async throws
    
    /// Get items for a specific item list
    /// - Parameter itemList: Core Data ItemList entity
    /// - Returns: Array of ItemDomain models
    ...
    /// - Parameters:
    ///   - itemListId: UUID of the item list
    ///   - isPaid: New paid status
